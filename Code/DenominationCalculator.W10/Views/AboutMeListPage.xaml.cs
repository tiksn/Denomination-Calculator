...
{
    public sealed partial class AboutMeListPage : PageBase , INotifyPropertyChanged    {
        private DataTransferManager _dataTransferManager;

        public AboutMeListPage()
        {
            this.ViewModel = new ListViewModel<LocalStorageDataConfig, HtmlSchema>(new AboutMeConfig());
